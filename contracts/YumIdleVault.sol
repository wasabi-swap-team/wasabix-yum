...
contract YumIdleVault is  ReentrancyGuard {
  ...
  {
    require(_governance != ZERO_ADDRESS, "YumIdleVault: governance address cannot be 0x0.");
    require(_sentinel != ZERO_ADDRESS, "YumIdleVault: sentinel address cannot be 0x0.");
  ...
  function setPendingGovernance(address _pendingGovernance) external onlyGov {
    require(_pendingGovernance != ZERO_ADDRESS, "YumIdleVault: governance address cannot be 0x0.");
  ...
  function setTransmuter(address _transmuter) external onlyGov {
    ...
    require(_transmuter != ZERO_ADDRESS, "YumIdleVault: transmuter address cannot be 0x0.");
  ...
  function setRewards(address _rewards) external onlyGov {
    ...
    // transfers to the address because of `safeTransfer` checks.
    require(_rewards != ZERO_ADDRESS, "YumIdleVault: rewards address cannot be 0x0.");
  ...
  function setCollateralizationLimit(uint256 _limit) external onlyGov {
    ...
    require(_limit >= MINIMUM_COLLATERALIZATION_LIMIT, "YumIdleVault: collateralization limit below minimum.");
    require(_limit <= MAXIMUM_COLLATERALIZATION_LIMIT, "YumIdleVault: collateralization limit above maximum.");
  ...
  modifier expectInitialized() {
    require(initialized, "YumIdleVault: not initialized.");
    _;
  }
  ...
  ///
  modifier onlyGov() {
    require(msg.sender == governance, "YumIdleVault: only governance.");
    _;
  }
